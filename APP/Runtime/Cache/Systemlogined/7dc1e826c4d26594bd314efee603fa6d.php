				...
				<div id="page-content" class="clearfix">
					...
					<div class="row-fluid">
						<!--PAGE CONTENT BEGINS HERE-->
							<form class="form-horizontal" name="addAnnounce" enctype="multipart/form-data"   action="<?php echo U(GROUP_NAME.'/Info/aboutpost');?>" method="post">
								<div class="control-group">
									<label class="control-label" for="title"> 标题</label>

									<div class="controls">
										<input type="text" value="<?php echo ($about["title"]); ?>" name="title" id="title" placeholder="" />
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" readonly="readonly" value="<?php echo ($about["operator"]); ?>" name="operator" id="operator" />
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<textarea name="content" style="width:700px; height:300px"><?php echo ($about["content"]); ?></textarea>
									</div>
								</div>
								<input type="hidden" name="aid" value="<?php echo ($about["id"]); ?>">
