			...
			<div id="main-content" class="clearfix">
				...
				<div id="page-content" class="clearfix">
                       <div class="page-header position-relative">
						 ...
						 <a type="button" href="<?php echo U(GROUP_NAME.'/Member/fafangshouyi');?>" class="btn btn-info btn-small no-border"> <i class="icon-plus icon-white"></i>发放收益</a>
						    </div>
					   </div>
					<div class="row-fluid">
							...
							<table id="table_report" class="table table-striped table-bordered table-hover">
								...
								<tbody>
                                    <?php if(is_array($orders)): foreach($orders as $key=>$v): ?><tbody> 
                                        ...
                                        <td class="hidden-480"><?php echo ($v["sumprice"]); ?>FCC</td>
