...
<div class="exchange">
        ...
        <li style="margin-top: 1px;width:100%">
            <span style="display:inline-block;width:20%;font-size: 0.8rem;">充值金额:</span>
            <input name="money" type="text" placeholder="请输入充值金额" style="height: 40px;line-height: 40px;width: 78%;border-radius: 4px;border: none; background:rgb(239, 239, 239);padding-left: 5px;-webkit-appearance:none; color:#39393d;">
        </li>
