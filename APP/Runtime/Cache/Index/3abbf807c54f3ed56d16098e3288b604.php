...
<body>
	...
	<div class="wechat__panel clearfix">
		<div class="wc__home-wrapper flexbox flex__direction-column">
			...
			<!-- <div id="#" style="color: #005580;font-size: 0.325rem;text-align: center">
				<a class="barTxt" href="<?php echo U('Index/wallet/yuelog');?>">余额明细>></a>
			</div> -->
			<!-- <div id="#" >
				<a class="barTxt" href="<?php echo U('Index/index/index');?>" style="margin:0.35rem auto 0;display: block;color: #1172ff;border: 1px solid #1172ff;width: 3.5rem;height: 0.8rem;padding: 0.1rem 0;font-size: 0.425rem;border-radius: 0.3rem;text-align: -webkit-center;background: #fff;">返回首页</a>
