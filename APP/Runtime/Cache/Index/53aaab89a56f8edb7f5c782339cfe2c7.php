...
<body class="loginbg mui-android mui-android-5 mui-android-5-0">
	...
	<div >
	<img src="/images/loginlogo.png" style="width:20%;margin-left:40%;margin-top:70px;border-radius:10px;margin-bottom:auto"/>
	</div>
	
<div style="height:40px;"></div>

	<form action="" id="myform" method="post"style="margin-top:auto; ">
		...
		<input type="hidden"  name="parent"  id="parent"  value="<?php echo ($d_key); ?>">
			...
			<div style="margin-left: 5%;width: 95%; height: auto;border-bottom: 1px solid #e3e3e3;">
				真实姓名：<input name="truename"  id="truename"  value="" maxlength="11" type="text" style="width: 70%;color: #999999;font-size: 1em;-webkit-appearance: none;border: none;outline: medium;" autocomplete="off" placeholder="与提现银行卡一致！" />
			</div>
			...
			<input type="hidden" name="alipay_voucher" value="" id="alipay_voucher">
             <div style="margin-left: 5%;width: 95%; height: auto;border-bottom: 1px solid #e3e3e3;">
				...
				<img src="<?php echo U('Sem/verify');?>" onClick="this.src='<?php echo U('Sem/verify','','');?>?'+Math.random();" width="60" height="30" >
             </div>
			...
			<div style="margin-left: 5%;width: 95%; height: auto;border-bottom: 1px solid #e3e3e3;">
			  	推荐人号：<input type="text"  name="id"  id="id"  value="<?php echo ($e_keyid); ?>" style="width: 70%;color: #999999;font-size: 1em;-webkit-appearance: none;border: none;outline: medium;" disabled>
			</div>
