...
<!-- saved from url=(0051)http://web.ykbnn.cn/ggz/register.aspx?userId=104646 -->
                ...
                <div class="swiper-container redSwiper swiper-container-vertical swiper-container-android">
                    <div class="swiper-wrapper" style="transition-duration: 400ms; transform: translate3d(0px, -120px, 0px);">
                                ...
                                <div class="swiper-slide" style="height: 30px; margin-bottom: 10px;">
                                    <p class="name">136****7895</p>
                                    <p class="data"> 8.88 元</p>
                                </div>
								<div class="swiper-slide" style="height: 30px; margin-bottom: 10px;">
								    <p class="name">156****4583</p>
								    <p class="data"> 8.88 元</p>
								</div>
								...
								<div class="swiper-slide" style="height: 30px; margin-bottom: 10px;">
								    <p class="name">156****5328</p>
								    <p class="data"> 8.88 元</p>
								</div>
								
								<div class="swiper-slide" style="height: 30px; margin-bottom: 10px;">
								    <p class="name">186****2128</p>
								    <p class="data"> 8.88 元</p>
								</div>
								
								<div class="swiper-slide" style="height: 30px; margin-bottom: 10px;">
								    <p class="name">155****7809</p>
								    <p class="data"> 8.88 元</p>
								</div>
								
								<div class="swiper-slide" style="height: 30px; margin-bottom: 10px;">
								    <p class="name">156****4403</p>
								    <p class="data"> 8.88 元</p>
								</div>
								
								<div class="swiper-slide" style="height: 30px; margin-bottom: 10px;">
								    <p class="name">136****4965</p>
								    <p class="data"> 8.88 元</p>
								</div>
        ...
        <div class="pop redModal" style="display: none;">
            ...
            <div class="modalRed">
                <div class="redContent">
                    ...
                    <p>恭喜您获得</p>
                    <p class="price">8.88<span>元</span></p>
                </div>
